...
本项目严格追踪 [Khev/swarmalators](https://github.com/Khev/swarmalators) 中的核心论文系列，按拓扑与模型特性分类归档，提供完备的学习笔记与复现代码：

| # | 论文题目 | 发表期刊 / 年份 | 空间拓扑 | 核心特征 / 现象 | 本地复现目录 | 状态 |
| :---: | :--- | :---: | :---: | :--- | :--- | :---: |
| 01 | [Oscillators that sync and swarm](https://www.nature.com/articles/s41467-017-01190-3) | *Nature Comms* 2017 | 2D 平面 $\mathbb{R}^2$ | 奠基之作，发现五种经典宏观相态 | [`papers/2d-plane/01-sync-and-swarm-natcomm2017`](papers/2d-plane/01-sync-and-swarm-natcomm2017/) | ✅ 已支持 |
| 02 | [Ring states in swarmalator systems](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.98.022203) | *Phys. Rev. E* 2018 | 1D 圆环 $S^1$ | 环上群聚振子，序参量 $S, R, S_{\pm}$ | [`papers/1d-ring/01-ring-states-pre2018`](papers/1d-ring/01-ring-states-pre2018/) | ✅ 已支持 |
| 03 | [Collective behavior of swarmalators on a ring](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.105.014211) | *Phys. Rev. E* 2022 | 1D 圆环 $S^1$ | Ott-Antonsen 连续极限分岔理论 | [`papers/1d-ring/02-collective-ring-pre2022`](papers/1d-ring/02-collective-ring-pre2022/) | ⏳ 规划中 |
| 04 | [Solvable model of non-identical swarmalators](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.129.208002) | *Phys. Rev. Lett.* 2022 | 1D 圆环 $S^1$ | 非全同频率 $\omega_i \sim g(\omega)$ 的严格可解模型 | [`papers/1d-ring/03-non-identical-prl2022`](papers/1d-ring/03-non-identical-prl2022/) | ⏳ 规划中 |
| 05 | [Swarmalators on a ring with distributed couplings](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.105.064208) | *Phys. Rev. E* 2022 | 1D 圆环 $S^1$ | 随机耦合强度分布与失挫竞争机制 | [`papers/1d-ring/04-distributed-couplings-pre2022`](papers/1d-ring/04-distributed-couplings-pre2022/) | ⏳ 规划中 |
| 06 | [Mixed sign interactions in the 1D swarmalator model](https://arxiv.org/abs/2309.02342) | *arXiv* 2023 | 1D 圆环 $S^1$ | 正负混合符号耦合与自旋玻璃行为 | [`papers/1d-ring/05-mixed-interactions-arxiv2023`](papers/1d-ring/05-mixed-interactions-arxiv2023/) | ⏳ 规划中 |
| 07 | [Pinning in a system of swarmalators](https://arxiv.org/abs/2211.02353) | *arXiv* 2022 | 1D 圆环 $S^1$ | 空间固定缺陷（Pinning）与解钉扎相变 | [`papers/1d-ring/06-pinning-transitions-arxiv2022`](papers/1d-ring/06-pinning-transitions-arxiv2022/) | ⏳ 规划中 |
| 08 | [Swarmalators on a Torus](https://github.com/Khev/swarmalators/tree/master/2D/on-torus) | *PRE* 2022 | 2D 环面 $\mathbb{T}^2$ | 周期边界条件下的拓扑波态 | [`papers/2d-plane/02-on-torus-pre2022`](papers/2d-plane/02-on-torus-pre2022/) | ⏳ 规划中 |
| 09 | [A solvable two dimensional swarmalator model](https://arxiv.org/abs/2312.10178) | *arXiv* 2023 | 2D 平面 $\mathbb{R}^2$ | 二维解析可解 Swarmalator 模型 | [`papers/2d-plane/04-solvable-2d-arxiv2023`](papers/2d-plane/04-solvable-2d-arxiv2023/) | ⏳ 规划中 |
| 10 | [Swarmalators on a 1D Line](https://github.com/Khev/swarmalators/tree/master/1D/on-line) | *Preprint* | 1D 线段 $\mathbb{R}$ | 线性无界/有界线段上的聚集与边界效应 | [`papers/1d-line/01-line-models`](papers/1d-line/01-line-models/) | ⏳ 规划中 |
